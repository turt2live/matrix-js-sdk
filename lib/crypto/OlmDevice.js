 ...
 */
OlmDevice.prototype.init = (0, _bluebird.method)(function () {
    var e2eKeys = void 0;
...
OlmDevice.prototype.sign = function () {
    var _ref2 = (0, _bluebird.method)(function (message) {
 ...
 * key.
 */
OlmDevice.prototype.getOneTimeKeys = (0, _bluebird.method)(function () {
    return this._getAccount(function (account) {
 ...
 */
OlmDevice.prototype.markKeysAsPublished = (0, _bluebird.method)(function () {
    var self = this;
 ...
 */
OlmDevice.prototype.generateOneTimeKeys = function () {
    var _ref5 = (0, _bluebird.method)(function (numKeys) {
        var self = this;
        this._getAccount(function (account) {
...
OlmDevice.prototype.createOutboundSession = function () {
    var _ref6 = (0, _bluebird.method)(function (theirIdentityKey, theirOneTimeKey) {
        var self = this;
        return this._getAccount(function (account) {
            var session = new Olm.Session();
            try {
...
OlmDevice.prototype.createInboundSession = function () {
    var _ref7 = (0, _bluebird.method)(function (theirDeviceIdentityKey, message_type, ciphertext) {
        if (message_type !== 0) {
...
OlmDevice.prototype.getSessionIdsForDevice = function () {
    var _ref8 = (0, _bluebird.method)(function (theirDeviceIdentityKey) {
...
OlmDevice.prototype.getSessionIdForDevice = function () {
    var _ref9 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee(theirDeviceIdentityKey) {
        var sessionIds;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 5:
                        ...
                        sessionIds.sort();
                        return _context.abrupt("return", sessionIds[0]);
...
OlmDevice.prototype.getSessionInfoForDevice = function () {
    var _ref10 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee2(deviceIdentityKey) {
        var sessionIds, info, getSessionInfo, i, sessionId, res;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        getSessionInfo = function getSessionInfo(session) {
                            return {
                        ...
                        _context2.next = 3;
                        return (0, _bluebird.resolve)(this.getSessionIdsForDevice(deviceIdentityKey));
                    ...
                    case 3:
                        ...
                        for (i = 0; i < sessionIds.length; i++) {
                            ...
                            res = this._getSession(deviceIdentityKey, sessionId, getSessionInfo);
...
OlmDevice.prototype.encryptMessage = function () {
    var _ref11 = (0, _bluebird.method)(function (theirDeviceIdentityKey, sessionId, payloadString) {
        var self = this;
...
OlmDevice.prototype.decryptMessage = function () {
    var _ref12 = (0, _bluebird.method)(function (theirDeviceIdentityKey, sessionId, message_type, ciphertext) {
        var self = this;
...
OlmDevice.prototype.matchesSession = function () {
    var _ref13 = (0, _bluebird.method)(function (theirDeviceIdentityKey, sessionId, message_type, ciphertext) {
        if (message_type !== 0) {
            return false;
        }
 ...
 * @private
 */
OlmDevice.prototype._saveInboundGroupSession = function (senderCurve25519Key, sessionId, sessionData) {
    this._sessionStore.storeEndToEndInboundGroupSession(senderCurve25519Key, sessionId, (0, _stringify2.default)(sessionData));
};
...
OlmDevice.prototype.addInboundGroupSession = function () {
    var _ref14 = (0, _bluebird.method)(function (roomId, senderKey, forwardingCurve25519KeyChain, sessionId, sessionKey, keysClaimed, exportFormat) {
        var self = this;
        ...
        try {
            ...
            self._saveInboundGroupSession(senderKey, sessionId, sessionData);
        } finally {
            session.free();
        }
    });

    return function (_x22, _x23, _x24, _x25, _x26, _x27, _x28) {
 ...
 */
OlmDevice.prototype.importInboundGroupSession = function () {
    var _ref15 = (0, _bluebird.method)(function (data) {
        /* if we already have this session, consider updating it */
        function updateSession(session, sessionData) {
        ...
        try {
            ...
            this._saveInboundGroupSession(data.sender_key, data.session_id, sessionData);
        } finally {
            session.free();
        }
    });
...
OlmDevice.prototype.decryptGroupMessage = function () {
    var _ref16 = (0, _bluebird.method)(function (roomId, senderKey, sessionId, body) {
        var self = this;
...
OlmDevice.prototype.hasInboundSessionKeys = function () {
    var _ref17 = (0, _bluebird.method)(function (roomId, senderKey, sessionId) {
        ...
        var r = JSON.parse(s);
        if (roomId !== r.room_id) {
            console.warn("requested keys for inbound group session " + senderKey + "|" + (sessionId + ", with incorrect room_id (expected " + r.room_id + ", ") + ("was " + roomId + ")"));
            return false;
        }
...
OlmDevice.prototype.getInboundGroupSessionKey = function () {
    var _ref18 = (0, _bluebird.method)(function (roomId, senderKey, sessionId) {
        ...
        return this._getInboundGroupSession(roomId, senderKey, sessionId, getKey);
    });
...
OlmDevice.prototype.exportInboundGroupSession = function () {
    var _ref19 = (0, _bluebird.method)(function (senderKey, sessionId) {
        var s = this._sessionStore.getEndToEndInboundGroupSession(senderKey, sessionId);
